...
kfreq_AB1 = dataAB1[9,:]      # Kepler limit
...
kfreq_AB2 = dataAB2[9,:]      # Kepler limit
...
kfreq_AB3 = dataAB3[9,:]      # Kepler limit
...
kfreq_AP = dataAP[9,:]      # Kepler limit
...
kfreq_B1 = dataB1[9,:]      # Kepler limit
...
kfreq_B2 = dataB2[9,:]      # Kepler limit
...
kfreq_HL1 = dataHL1[9,:]      # Kepler limit
...
kfreq_HL2 = dataHL2[9,:]      # Kepler limit
...
kfreq_HL3 = dataHL3[9,:]      # Kepler limit
...
delta_AB1 = freq_AB1 * (2*np.pi) * ((rstat_AB1**3)/(G*mstat_AB1))**(0.5)   # Normalized omega
...
delta_AB2 = freq_AB2 * (2*np.pi) * ((rstat_AB2**3)/(G*mstat_AB2))**(0.5)   # Normalized omega
...
delta_AB3 = freq_AB3 * (2*np.pi) * ((rstat_AB3**3)/(G*mstat_AB3))**(0.5)   # Normalized omega
...
delta_AP = freq_AP * (2*np.pi) * ((rstat_AP**3)/(G*mstat_AP))**(0.5)   # Normalized omega
...
delta_B1 = freq_B1 * (2*np.pi) * ((rstat_B1**3)/(G*mstat_B1))**(0.5)   # Normalized omega
...
delta_B2 = freq_B2 * (2*np.pi) * ((rstat_B2**3)/(G*mstat_B2))**(0.5)   # Normalized omega
...
delta_HL1 = freq_HL1 * (2*np.pi) * ((rstat_HL1**3)/(G*mstat_HL1))**(0.5)   # Normalized omega
...
delta_HL2 = freq_HL2 * (2*np.pi) * ((rstat_HL2**3)/(G*mstat_HL2))**(0.5)   # Normalized omega
...
delta_HL3 = freq_HL3 * (2*np.pi) * ((rstat_HL3**3)/(G*mstat_HL3))**(0.5)   # Normalized omega
...
delta_L = freq_L * (2*np.pi) * ((rstat_L**3)/(G*mstat_L))**(0.5)   # Normalized omega
